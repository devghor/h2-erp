...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        $middleware->alias([
            ...
            'set_tenant_permissions' => \App\Http\Middleware\SetTenantPermissions::class,
            'initialize_tenancy_by_request_data' => \Stancl\Tenancy\Middleware\InitializeTenancyByRequestData::class,
        ]);
    })
    ->withExceptions(function (Exceptions $exceptions): void {
        ...
        $exceptions->render(function (MethodNotAllowedHttpException $e, $request) {
            if ($request->expectsJson() || $request->is('api/*')) {
                return ApiResponse::error('Method not allowed', ['method' => ['The HTTP method is not allowed for this endpoint.']], Response::HTTP_METHOD_NOT_ALLOWED);
            }
        });
        ...
        $exceptions->render(function (Throwable $e, $request) {
            if ($request->expectsJson() || $request->is('api/*')) {
                ...
                return ApiResponse::error($message, $errors, Response::HTTP_INTERNAL_SERVER_ERROR);
            }
        });
    })->create();
